...
const DARK: ThemeTokens = {
  ...
  // Faint by design: an outline should hint at where a card ends, not compete
  // with the content inside it. borderStrong exists for the few things that
  // need more separation — a hovered card, a focused control.
  border: '#1f2946',
  borderStrong: '#2b3659',
  text: '#e7ecf8',
  textMuted: '#c3cee6',
